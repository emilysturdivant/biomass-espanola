...
var_order <- c('simple', 'cap7k_conserv13', 'agg50', 'lee11s10', 'med5', 'cap7k_med5')
var_order <- c('simple', 'cappt2_conserv13', 'agg50', 'lee11s10', 'med5', 'cappt2_med5')
...
There is no significant difference in performance statistics between filtering options so we'll use 5x5 median as the simplest. 